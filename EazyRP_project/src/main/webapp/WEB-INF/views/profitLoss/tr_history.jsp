				...
				<div class="card card-outline card-info">
					<div class="card-header" style="border-bottom: none; padding-bottom: 0px;">
						...
						<form id="searchForm2" method="post" action="/profitLoss/tr_history.do?mcode=${mcode }" style="font-size:0.9em; margin-left: 15%;">
							...
							발생 날짜 <input type="date" value="${cri2.startDate }" name="startDate" style="margin: 10px; width:15%; display: inline; font-size: 0.9em;"class="form-control">
							 ~ <input type="date" value="${cri2.endDate }" name="endDate" style="margin: 10px; width:15%; display: inline; font-size: 0.9em;"class="form-control">
					...
					<a href="/profitLoss/regbtn.do">생성하기</a>
