...
<nav id="navSideBar"class="d-flex flex-column p-3 sideMenuList" style=" float:left ; width: 15%; height: 100%; display: inline; background: linear-gradient(to bottom, #7bc4b2, #00ff72);">
		...
		<div class="mousePoint">
			<a class="p-2 a nav-link bold fw-bold " href="javascript:goPage('${myMenu.MURL }', '${myMenu.MCODE }', '${myMenu.MNAME }');" data-url="M040100" aria-expanded="true" style="color: white; text-decoration-line: none;">${myMenu.MNAME }</a>
		</div>
		</c:forEach>
</nav>
