...
<table border="1px solid">
	...
	<tr height="30px">
		<td width="100px" style="text-align: center;">Aasdfasdf</td>
		<td width="100px" style="text-align: center;">xcvbxcvbxcvb</td>
		<td width="100px" style="text-align: center;">qwerqwer</td>
	</tr>
</table>
</div>
<table border="1px solid" style="justify-data: center; align-data: center; width: 80%;">
	<tr height="30px">
