					...
					<div class="card-body pad">
						<form role="form" method="post" action="regist.do" name="registForm">
							<div class="form-group col-sm-12 row">
								...
								<input type="text" id="pc_no" name="pc_no" class="form-control col-sm-9" placeholder="상품코드를 입력하세요.">
							</div>
							<div class="form-group col-sm-12 row">
								<label for="pc_name" class="col-sm-3">쇼핑몰 코드</label>
								<input type="text" id="pc_name" name="pc_name" class="form-control col-sm-9" value="" placeholder="쇼핑몰코드를 입력하세요.">
							</div>
							<div class="form-group col-sm-12 row">
								<label for="pc_name" class="col-sm-3">제품코드</label>
								<input type="text" id="pc_name" name="pc_name" class="form-control col-sm-9" value="" placeholder="제품코드를 입력하세요.">
							</div>
							<div class="form-group col-sm-12 row">
							...
							<div class="form-group col-sm-12 row">
								...
								<input type="text" id="pc_name" name="pc_name" class="form-control col-sm-9" value="" placeholder="판매시작일을 입력하세요.">
							</div>
							<div class="form-group col-sm-12 row">
								<label for="pc_name" class="col-sm-3">판매종료일</label>
								<input type="text" id="pc_name" name="pc_name" class="form-control col-sm-9" value="" placeholder="판매종료일을 입력하세요.">
							</div>
						</form>
					</div>
