				...
				<div class="card card-outline card-info">
					...
					<div class="card-body">	<!-- card body Start -->
						<div class="form-group col-sm-12">
							...
							<input type="text" class="form-control" id="title" value="${process.pc_code }" readonly>
						</div>
						<div class="row">
							<div class="form-group col-sm-4">
								<label for="writer">작성자</label>
								<input type="text" class="form-control" id="writer" value="${process.pc_name }" readonly>
							</div>
							<div class="form-group col-sm-4">
							...
							<div class="form-group col-sm-4">
								...
								<input type="text" class="form-control" id="viewcnt" value="${process.pc_order }" readonly>
							</div>
						</div>
						<div class="form-group col-sm-12">
