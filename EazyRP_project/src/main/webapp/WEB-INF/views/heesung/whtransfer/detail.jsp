...
<form role="form" method="post" enctype="multipart/form-data">
		...
		<table>
	        ...
	        <tr><input type="hidden" id="A" value="C">
            	<td align="center"><b>보내는 창고</b></td>
             	<td>
             		<input type="text" id="give_wh_name" class="wh_names" style="width: 100%;" value="${wht.WH_NAME }">
        	...
        	<tr>
				...
				<td>
					<input type="text" id="take_wh_name" class="wh_names2" style="width: 100%;" value="${wht.WH_NAME2 }">
	...
	<%-- 	       <input type="hidden" name="enabled" id="estenabled" value="${est.ENABLED }"> --%>
	        	...
	        	<td>
	        		<input type="text" id="pr_no${whtDetail.ROWNUM }" class="pr_names" name="pr_no" style="width: 100%;" value="${whtDetail.PR_NO }">
	        	</td>
	        	<td>	
					<input type="text" id="pr_name${whtDetail.ROWNUM }" class="pr_names" name="pr_name" style="width: 100%;" value="${whtDetail.PR_NAME }">
				</td>
				<td>
					<input type="text" id="quantity" class="quantity" name="quantity" style="width: 100%;" value="${whtDetail.QUANTITY }">
				</td>
