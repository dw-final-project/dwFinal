					...
					<div class="card-body pad">
						<form role="form" method="post" action="regist.do" name="registForm">
							<div class="form-group">
								<label for="pc_code">생산 공정 코드</label>
								<input type="text" id="pc_code" name="pc_code" class="form-control" placeholder="제목을 입력하세요.">
							</div>
							<div class="form-group">
								<label for="pc_name">생산 공정 이름</label>
								<input type="text" id="pc_name" name="pc_name" class="form-control" value="">
							</div>
							<div class="form-group">
								<label for="pc_order">순번</label>
