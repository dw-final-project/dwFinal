...
<div class="card-body pad">
	...
	<div class="input-group row" style="width: 100%; margin: 0px 0px 20px 0px; justify-content: center;">
		<form method="post" action="/jihwan/findProduct.do" style="display: contents;">
	...
	<div>	
		<table style="font-size: 0.8em;" class="table table-borderd text-center">
			<tr>
				...
				<tr>
					<td style="text-align: center;" id="pr_name">${pro.pr_name }</td>
					<td style="text-align: center;" id="c_name">${pro.c_name }</td>
				</tr>
				</c:forEach>
		</table>
	</div>
